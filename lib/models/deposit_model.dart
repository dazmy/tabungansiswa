...
class DepositModel {
  ...
  DepositModel({required this.id, required this.deposit, required this.studentId, required this.studentModel,});
  ...
  // for grade page
  DepositModel.fromJsonGrade(Map<String, dynamic> json) {
    id = json['id'];
    deposit = json['deposit'];
    studentId = json['student_id'];
    inputDate = DateTime.parse(json['input_date']);
